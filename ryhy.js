...
if (process.env.ryhyheader && process.env.ryhyheader.indexOf('\n') > -1) {
  ryhyheaderArr.push(process.env.ryhyheader.split('\n'))
} else {
  ryhyheaderArr.push(process.env.ryhyheader.split())
};
if (process.env.ryhyadbody && process.env.ryhyadbody.indexOf('\n') > -1) {
  ryhyadbodyArr.push(process.env.ryhyadbody.split('\n'))
}  else if(process.env.ryhyadbody !== undefined) {
  ryhyadbodyArr.push(process.env.ryhyadbody.split())
};
if (process.env.ryhyadheader && process.env.ryhyadheader.indexOf('\n') > -1) {
  ryhyadheaderArr.push(process.env.ryhyadheader.split('\n'))
