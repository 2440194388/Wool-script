...
!(async () => {
  if (typeof $request !== "undefined") {
    ...
    if (process.env.scdcghd && process.env.scdcghd.indexOf('\n') > -1) {
      scdcghdArr.push(process.env.scdcghd.split('\n'))
    } else {
      scdcghdArr.push(process.env.scdcghd.split())
    };
    if (process.env.scdcgbody && process.env.scdcgbody.indexOf('\n') > -1) {
      scdcgbodyArr.push(process.env.scdcgbody.split('\n'))
    }  else if(process.env.scdcgbody !== undefined) {
      scdcgbodyArr.push(process.env.scdcgbody.split())
    };
    if (process.env.scdcgspbody && process.env.scdcgspbody.indexOf('\n') > -1) {
      scdcgspbodyArr.push(process.env.scdcgspbody.split('\n'))
    } else if(process.env.scdcgspbody !== undefined) {
      scdcgspbodyArr.push(process.env.scdcgspbody.split())
    };
